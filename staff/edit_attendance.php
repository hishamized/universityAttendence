                ...
                <?php if (isset($attendance)) : ?>
                    <?php foreach ($attendance as $record) : ?>
                        <tr>
                            ...
                            <td>
                                <form action="" method="" id="editForm<?= $record['id'] ?>">
                                    ...
                                    <input type="hidden" id="name<?= $record['id'] ?>" value="<?php echo $record['full_name'] ?>">
                                    <select class="form-select" id="attendance" name="attendance">
                                        <option value="present" <?php echo $record['status'] === 'present' ? 'selected' : '' ?> class="bg-success text-white">Present</option>
                                        <option value="absent" <?php echo $record['status'] === 'absent' ? 'selected' : '' ?> class="bg-danger text-white">Absent</option>
                                        <option value="on_leave" <?php echo $record['status'] === 'on_leave' ? 'selected' : '' ?> class="bg-warning text-dark">On Leave</option>

                                    </select>
                                    <button type="button" onclick="ajaxEditAttendence(<?php echo $record['id'] ?>)" name="updateAttendance" class="btn btn-success my-3">Update</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
