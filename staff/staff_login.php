...
// Check if staff is already logged in, redirect to dashboard if true
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        if (password_verify($password, $staff['password'])) {
            // staff authenticated, create session and redirect to dashboard
        ...
        $error_message[] = "Staff Member not found. Check login credentials.";
    }
}
